...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag.setlayout(awful.layout.layouts[4], s.tags[1])
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "x",     function () awful.tag.incnmaster(-1, nil, true) end,
              {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ modkey, "Control" }, "a",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey, "Control" }, "x",     function () awful.tag.incncol(-1, nil, true)    end,
...
-- }}}
awful.spawn("chromium", { tag = awful.screen.focused().tags[1] })
awful.spawn(terminal, { tag = awful.screen.focused().tags[2] })
